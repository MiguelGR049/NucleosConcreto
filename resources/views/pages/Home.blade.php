...
<div class="container d-flex flex-column justify-content-center align-items-center">
    ...
    <div class="d-flex flex-wrap justify-content-center gap-2 mt-4">
        <a href="{{ route('ensayo') }}" id="ensayo" class="btn d-flex flex-column justify-content-center align-items-center text-decoration-none">
            <i class="fa-solid fa-vial mb-1"></i>
            Ensayo
        </a>
        <a href="{{ route('consulta') }}" id="consulta" class="btn d-flex flex-column justify-content-center align-items-center text-decoration-none">
